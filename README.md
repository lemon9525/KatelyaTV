...
A: KatelyaTV 当前专注于点播（VOD）内容，不直接支持直播频道管理。不过播放器技术上支持 M3U8 直播流。详细说明请参阅 [直播功能支持指南](LIVE_STREAMING_GUIDE.md)。
...
- ✅ **点播内容（VOD）**：电影、电视剧、综艺、动漫等完整视频内容
- ✅ **分集播放**：支持多集电视剧的分集管理和播放
- ✅ **M3U8 流媒体**：支持 HLS 格式的视频流播放
- ❌ **直播频道**：当前不直接支持电视直播功能

> **📝 关于直播功能**：如需了解直播支持情况，请参阅 [直播功能支持指南](LIVE_STREAMING_GUIDE.md)
